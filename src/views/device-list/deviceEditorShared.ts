      ...
      capMethod:
        captureMethodType === 'adb'
          ...
          : {
              ...
              offsetLeftPx: normalized.windowOffsets.left,
              offsetTopPx: normalized.windowOffsets.top,
              offsetRightPx: normalized.windowOffsets.right,
              offsetBottomPx: normalized.windowOffsets.bottom,
            },
