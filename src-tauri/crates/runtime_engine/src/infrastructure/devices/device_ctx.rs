...
impl DeviceCtx {
    pub fn new(
        ...
        let adapter: Arc<dyn DeviceAdapter> = match platform {
            DevicePlatform::Android => Arc::new(AndroidDeviceAdapter::new(capture_method, window_title)),
    ...
    pub async fn swipe(&self, from: Point<u16>, to: Point<u16>, duration: u64) -> Result<(), String> {
