use crate::app::config::sys_conf::{
    get_system_settings, save_window_state_if_enabled, set_system_settings,
};
...
/// 保存窗口状态
#[command]
pub async fn save_window_state_cmd(app_handle: AppHandle) -> Result<(), String> {
