use crate::app::config::log_conf::{
    update_log_level_app, update_log_dir_app, update_retention_days_app, get_log_config_app, clean_logs_now_app,
    update_child_log_level_app,
};
...
/// 更新日志目录
#[command]
pub async fn update_log_dir_cmd(
    log_dir: String,
) -> Result<String, String> {
...
/// 更新日志保留天数
#[command]
pub async fn update_retention_days_cmd(
    days: u32,
) -> Result<String, String> {
