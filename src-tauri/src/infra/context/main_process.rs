//! Root-process runtime state.
use crate::api::local::execution::DeviceLifecycleStatus;
use crate::infra::ipc::channel_server::IpcClientState;
use ad_kernel::ids::{DeviceId, DispatchId, JobId, MessageId, ScriptId, now_millis_string};
