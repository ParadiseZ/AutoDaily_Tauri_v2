//! Root application HTTP client and authenticated transfer adapter.
use crate::api::server::dto::{AuthRes, BackendApiRes, RefreshTokenReq};
use crate::app::app_error::{AppError, AppResult};
use crate::app::constants::{APP_STORE, AUTH_SESSION_KEY};
...
impl HttpClient {
    ...
    pub async fn post_api_res<T: DeserializeOwned, B: serde::Serialize>(
        &self,
        endpoint: &str,
        body: &B,
        ...
        C: FnMut() -> Result<(), String>,
    {
        ...
        on_progress(FileTransferProgress { transferred_bytes });
